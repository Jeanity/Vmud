...
- **1,379 tests** (777 server, 507 shared, 95 worldgen), typecheck clean across all five packages.
...
**Round 11 is open, and Track V skips its turn** — V1–V7 are all done, and §2b says a track with nothing
