...
- **1,361 tests** (771 server, 495 shared, 95 worldgen), typecheck clean across all five packages.
...
**Round 10's mechanic is Phase 19, skills, and its first slice landed 2026-08-06** — see the table row.
