...
- **1,273 tests** (710 server, 468 shared, 95 worldgen), typecheck clean across all five packages.
...
### Start here — A8 is done, and round 7 with it (2026-08-05)
...
**Round 8 is the next thing**, and the cadence (§2b) wants one of each kind:

- **Visual: V4, Places as a graph.** Its scope has not been read yet.
...
- **Admin: A4c** (loot on a mob, needs a mob overlay first) or **A7e/A7f** (recolour from a named
  palette ramp, then Ollama picking it — 424 of 657 ULPC sheets already declare `palettes`).
...
**all three A8 slices**; what is left there is A4c, A7e, A7f and A7d-bag.
